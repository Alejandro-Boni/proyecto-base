...
class AppGastos(ctk.CTk):
    def __init__(self):
        ...
        self.geometry("400x620") # Subimos un poco el alto para el nuevo botón
        ...
        # BOTÓN LIMPIAR (Nuevo - Color rojo/naranja)
        self.btn_limpiar = ctk.CTkButton(self, text="Limpiar Historial", command=self.limpiar_datos, fg_color="#c0392b", hover_color="#e74c3c")
    ...
    def limpiar_datos(self):
        """Borra el contenido del archivo y de la pantalla"""
        # Abrir el archivo en modo 'w' (write) vacía el archivo automáticamente
